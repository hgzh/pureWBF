; #author deseven, derivated by hgzh
; #url    https://github.com/deseven/pbsamples/blob/master/crossplatform/libcurl/libcurl.pbi
...
CompilerEndIf
  ...
  Declare curlWriteData(*ptr, Size, NMemB, *Stream)
  Declare.s curlGetData()
  Declare.s str2curl(string.s)
